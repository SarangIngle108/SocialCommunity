...
import 'package:social_media_app/core/type_defs.dart';
...
class CommunityRepository{
  ...
  CommunityRepository({required final FirebaseFirestore firestore}): _firestore = firestore;
  ...
  Stream<List<Post>> getCommmunityPosts(String name){
    return _posts.where('communityName',isEqualTo: name).orderBy('createdAt',descending: true)
        .snapshots().map((event) => event.docs.map((e) => Post.fromMap(e.data() as Map<String,dynamic>)).toList());
