...
import 'package:social_media_app/features/community/repository/community_repository.dart';
...
final getCommunityPostsProvider = StreamProvider.family((ref,String name) {
  return ref.watch(communityControllerProvider.notifier).getCommmunityPosts(name);
});
...
class CommunityController extends StateNotifier<bool>{
  ...
  CommunityController({
    required CommunityRepository communityRepository,required StorageRepository storageRepository,
    required Ref ref,
  }) : _communityRepository=communityRepository , _ref = ref,_storageRepository = storageRepository,super(false);
  ...
  void createCommunity(String name, BuildContext context) async{
    ...
    res.fold((l) => showSnackBar(context,l.message), (r){
      showSnackBar(context, '$name community created successfully');
  ...
  void joinCommunity(Community community,BuildContext context)async{
    ...
    res.fold((l) => showSnackBar(context,l.message), (r) {
      if(community.members.contains(user.uid)){
        ...
        showSnackBar(context, 'community joined succesfuly');
      }
    });
  }
  ...
  Stream<List<Post>> getCommmunityPosts(String name){
    return _communityRepository.getCommmunityPosts(name);
  }
